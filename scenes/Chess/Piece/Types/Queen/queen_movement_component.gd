...
func _get_piece_legal_moves(
	...
	var straight_moves = rook_component._get_piece_legal_moves(current_pos, board, board_dimensions, piece_owner, move_idx)
	var diagonal_moves = bishop_component._get_piece_legal_moves(current_pos, board, board_dimensions, piece_owner, move_idx)

...
func _create_promoted_piece(piece_type: ChessPiece.Type, owner_player: Player) -> ChessPiece:
	...
	match piece_type:
		ChessPiece.Type.QUEEN:
			scene_path = 'res://ChessModule/scenes/Piece/Types/Queen/queen.tscn'
		ChessPiece.Type.ROOK:
			scene_path = 'res://ChessModule/scenes/Piece/Types/Rook/rook.tscn'
		ChessPiece.Type.BISHOP:
			scene_path = 'res://ChessModule/scenes/Piece/Types/Bishop/bishop.tscn'
		ChessPiece.Type.KNIGHT:
			scene_path = 'res://ChessModule/scenes/Piece/Types/Knight/knight.tscn'
		_:

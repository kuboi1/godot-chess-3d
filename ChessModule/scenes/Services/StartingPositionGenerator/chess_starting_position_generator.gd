...
# Pieces preloads
const PIECE_SCENES = {
	ChessPiece.Type.PAWN: preload('res://ChessModule/scenes/Piece/Types/Pawn/pawn.tscn'),
	ChessPiece.Type.ROOK: preload('res://ChessModule/scenes/Piece/Types/Rook/rook.tscn'),
	ChessPiece.Type.KNIGHT: preload('res://ChessModule/scenes/Piece/Types/Knight/knight.tscn'),
	ChessPiece.Type.BISHOP: preload('res://ChessModule/scenes/Piece/Types/Bishop/bishop.tscn'),
	ChessPiece.Type.QUEEN: preload('res://ChessModule/scenes/Piece/Types/Queen/queen.tscn'),
	ChessPiece.Type.KING: preload('res://ChessModule/scenes/Piece/Types/King/king.tscn'),
}
